...
export default function AboutMe() {
  return (
    <Layout title="About Me" description="About Avisek Dalal — technical writer">
      <>
          ...
          <div className="container">
            <div className={styles.heroInner}>
              ...
              <p className={styles.intro}>
                ...
                scalable documentation for complex software products. Throughout
                my career, I have bridged the gap between engineering and users
                by collaborating with cross-functional teams to translate intricate
                technical functionality into intuitive documentation.
              </p>
              <p className={styles.intro}>
                I specialize in modern documentation strategies, with deep
                expertise in enterprise structured authoring (DITA XML) and
                Docs-as-Code workflows (Git and Markdown). By designing
                single-source content models in DITA XML, I ensure global
                consistency and eliminate repetitive maintenance. Simultaneously,
                I leverage Git, Markdown, and static site generators to embed
                documentation directly into engineering pipelines.
              </p>
              <p className={styles.intro}>
          ...
          <div className="container">
            ...
            <section className={styles.section}>
              ...
              <p className={styles.sectionSubtitle}>
                Technologies and platforms I use across authoring, publishing,
            ...
            <section className={styles.section}>
              ...
              <ol className={styles.timeline}>
                {experience.map((role) => (
                  <li key={`${role.year}-${role.company}`} className={styles.timelineItem}>
